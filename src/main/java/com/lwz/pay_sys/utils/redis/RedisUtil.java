package com.lwz.pay_sys.utils.redis;
...
public class RedisUtil {
    ...
    private void initJedisPool() {
        ...
        config.setMaxIdle(3);
        jedisPool = new JedisPool(config,"39.106.145.162",16379,3000,"liweizhong");
    }
...
//        RedisUtil client = RedisUtil.getInstance();
//        client.hash.hset("liweizhong","ceshi","aizazadi".getBytes());
//        System.out.println(client.hash.hget("liweizhong","ceshi"));
    }
}
class Student{
    private Integer id;
