...
public class PayConfigUtil {
    ...
    public static final String NOTIFY_URL = Constants.LOCALHOST + "/alipay/wxPay/Notify"; //回调url
    public static final String CREATE_IP = "112.74.135.224";  //ip地址
    public static final String UFDODER_URL = "https://api.mch.weixin.qq.com/alipay/unifiedorder"; //统一下单url，微信提供的
    public static final String QUERY_ORDER_STATE = "https://api.mch.weixin.qq.com/alipay/orderquery"; //查询订单支付状态url，微信提供
